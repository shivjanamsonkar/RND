...
int posListener(){
  ...
  /*  if(argc != 2) {
	...
	*/
	...
	printf("---------------------------------\n");
	printf("Put a telnet message here\n");
	printf("---------------------------------\n");
	...
	// print the buff data and release this loop, when implement in to pos devices.
